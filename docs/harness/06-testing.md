...
| `tests/factor_engine/test_evolution_l1_merge.py` | 13 | L1→L2 候选合并 + 精英晋升（v2.47.0 基础；v2.103.0+20 新增 2 用例——默认 shadow_observe 关闭（env 未设晋升记录无 shadow_pool）/FTS_EVOLUTION_SHADOW_OBSERVE=1 恢复（记录含 shadow_pool 且 observe_trading_days==5）） |
