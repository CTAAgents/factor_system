...
target_ids = {
    "cand_4b4dbd15", "cand_6e6052ab", "cand_397a955a",
    "cand_21901c83", "cand_65a24474", "cand_27cf8203",
    "cand_94f05aba", "cand_c73c4296", "cand_476bd29a",
}
target_names = {
    "IntradayRecoveryFactor", "VolumePriceDivergence", "RangeBreakoutMomentum",
    "AverageTrueRangePulse", "BiasSpotter", "HighLowAsymmetry",
    "VolumeWeightedPriceZScore", "ShockAbsorptionRatio", "MomentumQualityScore",
}
