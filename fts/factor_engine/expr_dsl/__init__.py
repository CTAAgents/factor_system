...
from .registry import L0_FIELDS, OperatorMeta, build_registry
...
__all__ = [
    "ExprNode", "ExprAnalysis",
    "FTSExprError", "DSLValidationError", "DSLExecutionError",
    "parse_expression", "validate_expr", "compute_max_lookback", "collect_fields",
    "evaluate", "build_registry", "OperatorMeta", "L0_FIELDS",
    "compile_expr_to_code", "analyze_expression", "eval_fts_expr",
]
