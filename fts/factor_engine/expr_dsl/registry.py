...
def build_registry() -> dict[str, OperatorMeta]:
    ...
    _c9_ops = [
        ...
        ("ts_ma_diff", _C9.ts_ma_diff, "L1", ("series", "short", "long"), ("short", "long"), (), {"short": (2, 60), "long": (5, 250)}, "long", "双均线差(趋势强弱)"),
    ...
    _d12_ops = [
        ...
        ("ts_adx_wilder", _D12.ts_adx_wilder, "L5", ("high", "low", "close", "window"), ("window",), (), {"window": (2, 100)}, "window", "Wilder ADX归一化[0,1]"),
        ("ts_atr_ratio", _D12.ts_atr_ratio, "L1", ("high", "low", "close", "window"), ("window",), (), {"window": (2, 100)}, "window", "ATR/价格(波动状态)"),
