...
def atomic_write(path: str | Path, data: Any, *, make_dir: bool = True, encoding: str = "utf-8") -> None:
    """原子写入 JSON 文件。
...
def atomic_read(path: str | Path, *, default: Any = None, encoding: str = "utf-8") -> Any:
    """安全读取 JSON 文件。
...
def atomic_write_state(path: str | Path, state: dict[str, Any], *, backup_count: int = 3) -> None:
